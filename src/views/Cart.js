...
export const Cart = () => {
  ...
  const sendOrder = async (e) => {
    ...
    let order = {
      ...
      productos: items,
      total: items.reduce(
        (ac, productos) => ac + productos.price * productos.count,
        0
      ),
    };
  ...
  return (
    <>
      <div className="container">
        <h4 className="mt-4">Carrito de compras</h4>
        <hr />
        {items.length > 0 && !purchaseComplete ? (
            ...
            <form id="purchase-form" onSubmit={sendOrder}>
              ...
              <div className="mb-3">
                ...
                <div id="emailHelp" className="form-text">
                  Nunca vamos a compartir tus datos personales
                </div>
              </div>
          ...
          <div style={{ textAlign: "center", marginTop: "1rem" }}>
            {purchaseComplete ? (
              <>
                <h2 className="p-5">Gracias por tu compra!</h2>
                <p>El pedido se ha procesado correctamente</p>
                <p>
                  En las proximas horas recibiras la confirmacion a tu email
                </p>
              </>
            ) : (
              <>
